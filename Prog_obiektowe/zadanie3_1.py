class ElectricCar():
  ...
  def __init__(self,zasieg):
      ...
      self.zasieg = zasieg   def drive (self,planowane):
      ...
      if planowane <= self.zasieg-self.przejechane:
          ...
          print(f'Nie wystarczy baterii, poniewaz przekracasz '
                ...
                f'{((planowane-(self.zasieg-self.przejechane))/self.zasieg)*100:.0f}%')    def charge(self):

       self.przejechane =0car = ElectricCar(150)
